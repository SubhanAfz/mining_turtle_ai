...
Let's say we want to create a small library to make working with the [terminal](../module/term.md) a little easier. We'll provide two
...
[  term.setCursorPos](../module/term.md#v:setCursorPos)(1, 1)
end

local function write_center(text)
  local x, y = [term.getCursorPos](../module/term.md#v:getCursorPos)()
  local width, height = [term.getSize](../module/term.md#v:getSize)()
[  term.setCursorPos](../module/term.md#v:setCursorPos)(math.floor((width - #text) / 2) + 1, y)
[  term.write](../module/term.md#v:write)(text)
end
