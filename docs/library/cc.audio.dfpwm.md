...
Typically DFPWM audio is read from [the filesystem](../module/fs.md#ty:ReadHandle) or [a web request](../module/http.md#ty:Response) as a string,
and converted to a format suitable for [`speaker.playAudio`](../peripheral/speaker.md#v:playAudio).

## Encoding and decoding files

This module exposes two key functions, [`make_decoder`](cc.audio.dfpwm.md#v:make_decoder) and [`make_encoder`](cc.audio.dfpwm.md#v:make_encoder), which construct a new decoder or encoder.
...
Instead, you can convert audio files online using [music.madefor.cc](https://music.madefor.cc/), the [LionRay Wav Converter](https://github.com/gamax92/LionRay/) Java
application or [FFmpeg](https://ffmpeg.org) 5.1 or later.
...
```
local [dfpwm ](cc.audio.dfpwm.md)= require("cc.audio.dfpwm")

local encoder = [dfpwm.make_encoder](cc.audio.dfpwm.md#v:make_encoder)()
local decoder = [dfpwm.make_decoder](cc.audio.dfpwm.md#v:make_decoder)()

local out = [fs.open](../module/fs.md#v:open)("speedy.dfpwm", "wb")
for input in [io.lines](../module/io.md#v:lines)("data/example.dfpwm", 16 * 1024 * 2) do
...
- **[`Playing audio with speakers`](../guide/speaker_audio.md)** Gives a more general introduction to audio processing and the speaker.
- **[`speaker.playAudio`](../peripheral/speaker.md#v:playAudio)** To play the decoded audio data.

### Changes

- **New in version 1.100.0**

[make_encoder()](#v:make_encoder)  Create a new encoder for converting PCM audio data into DFPWM. 

[encode(input)](#v:encode)  A convenience function for encoding a complete file of audio at once. 

[make_decoder()](#v:make_decoder)  Create a new decoder for converting DFPWM into PCM audio data. 

[decode(input)](#v:decode)  A convenience function for decoding a complete file of audio at once. 

[](#v:make_encoder)make_encoder()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/audio/dfpwm.lua#L104)
...
- **[`encode`](cc.audio.dfpwm.md#v:encode)** A helper function for encoding an entire file of audio at once.

[](#v:encode)encode(input)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/audio/dfpwm.lua#L220)

A convenience function for encoding a complete file of audio at once.

This should only be used for complete pieces of audio. If you are writing multiple chunks to the same place,
you should use an encoder returned by [`make_encoder`](cc.audio.dfpwm.md#v:make_encoder) instead.
...
- **[`make_encoder`](cc.audio.dfpwm.md#v:make_encoder)**

[](#v:make_decoder)make_decoder()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/audio/dfpwm.lua#L162)
...
local decoder = [dfpwm.make_decoder](cc.audio.dfpwm.md#v:make_decoder)()
for input in [io.lines](../module/io.md#v:lines)("data/example.dfpwm", 16 * 1024) do
  local decoded = decoder(input)
...
- **[`decode`](cc.audio.dfpwm.md#v:decode)** A helper function for decoding an entire file of audio at once.

[](#v:decode)decode(input)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/audio/dfpwm.lua#L206)
...
[`make_decoder`](cc.audio.dfpwm.md#v:make_decoder).
