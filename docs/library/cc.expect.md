...
The [`cc.expect`](cc.expect.md) library provides helper functions for verifying that
...
```
local [expect ](cc.expect.md)= require "cc.expect"
local [expect](cc.expect.md#v:expect), [field ](cc.expect.md#v:field)= [expect.expect](cc.expect.md#v:expect), [expect.field
](cc.expect.md#v:field)
local function add_person(name, info)
[    expect](cc.expect.md#v:expect)(1, name, "string")
[    expect](cc.expect.md#v:expect)(2, info, "table", "nil")

    if info then
        print("Got age=", [field](cc.expect.md#v:field)(info, "age", "number"))
        print("Got gender=", [field](cc.expect.md#v:field)(info, "gender", "string", "nil"))
    end
end
...
[](#v:expect)expect(index, value, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/expect.lua#L67)
...
[](#v:field)field(tbl, index, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/expect.lua#L95)
...
[](#v:range)range(num [, min=-math.huge [, max=math.huge]])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/expect.lua#L126)
