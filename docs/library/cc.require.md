...
```
local [r ](cc.require.md)= require "cc.require"
local env = setmetatable({}, { __index = _ENV })
env.require, env.package = [r.make](cc.require.md#v:make)(env, "/")

-- Now we have our own require function, separate to the original.
local r2 = env.require "cc.require"
print([r](cc.require.md), r2)
```

### See also

- **[`Reusing code with require`](../guide/using_require.md)** For an introduction on how to use [`require`](https://www.lua.org/manual/5.1/manual.html#pdf-require).
...
[](#v:make)make(env, dir)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/require.lua#L120)
