...
- **[`textutils`](../module/textutils.md)** For additional string related utilities.
...
[ensure_width(line [, width])](#v:ensure_width)  Makes the input string a fixed width. 

[split(str, deliminator [, plain=false [, limit]])](#v:split)  Split a string into parts, each separated by a deliminator. 

[](#v:wrap)wrap(text [, width])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/strings.lua#L32)

Wraps a block of text, so that each line fits within the given width.

This may be useful if you want to wrap text before displaying it to a
[`monitor`](../peripheral/monitor.md) or [`printer`](../peripheral/printer.md) without using [print](../module/_G.md#v:print).
...
```
[term.clear](../module/term.md#v:clear)()
local lines = [require "cc.strings".wrap](cc.strings.md#v:wrap)("This is a long piece of text", 10)
for i = 1, #lines do
[  term.setCursorPos](../module/term.md#v:setCursorPos)(1, i)
[  term.write](../module/term.md#v:write)(lines[i])
end
```

[](#v:ensure_width)ensure_width(line [, width])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/strings.lua#L100)
...
```
[require "cc.strings".ensure_width](cc.strings.md#v:ensure_width)("a short string", 20)
```

- 

```
[require "cc.strings".ensure_width](cc.strings.md#v:ensure_width)("a rather long string which is truncated", 20)
```

[](#v:split)split(str, deliminator [, plain=false [, limit]])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/modules/main/cc/strings.lua#L142)
...
```
[require "cc.strings".split](cc.strings.md#v:split)("This is a sentence.", "%s+")
```
...
```
[require "cc.strings".split](cc.strings.md#v:split)("a-separated-string-of-sorts", "-", true, 3)
```
