...
[_CC_DEFAULT_SETTINGS](#v:_CC_DEFAULT_SETTINGS)  The default computer settings as defined in the ComputerCraft configuration. 

[](#v:sleep)sleep(time)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L41)

Pauses execution for the specified number of seconds.

As it waits for a fixed amount of world ticks, `time` will automatically be
rounded up to the nearest multiple of 0.05 seconds. If you are using coroutines
or the [parallel API](parallel.md), it will only pause execution of the current
...
[`os.startTimer`](os.md#v:startTimer)), however it does not listen for any other events. This means
that any event that occurs while sleeping will be entirely discarded. If you
need to receive events while sleeping, consider using [timers](os.md#v:startTimer),
or the [parallel API](parallel.md).
...
- **[`os.startTimer`](os.md#v:startTimer)**

[](#v:write)write(text)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L50)
...
- **[`print`](_G.md#v:print)** A wrapper around write that adds a newline and accepts multiple arguments

[](#v:print)print(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L58)
...
[](#v:printError)printError(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L65)
...
[](#v:read)read([replaceChar [, history [, completeFn [, default]]]])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L113)
...
```
local [completion ](../library/cc.completion.md)= require "cc.completion"
local history = { "potato", "orange", "apple" }
local choices = { "apple", "orange", "banana", "strawberry" }
write("> ")
local msg = read(nil, history, function(text) return [completion.choice](../library/cc.completion.md#v:choice)(text, choices) end, "app")
print(msg)
```

### See also

- **[`cc.completion`](../library/cc.completion.md)** For functions to help with completion.
...
[](#v:_HOST)_HOST[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L129)

Stores the current ComputerCraft and Minecraft versions.

Outside of Minecraft (for instance, in an emulator) [`_HOST`](_G.md#v:_HOST) will contain the
...
[](#v:_CC_DEFAULT_SETTINGS)_CC_DEFAULT_SETTINGS[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/global.lua#L144)
