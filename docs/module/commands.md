...
While one may use [`commands.exec`](commands.md#v:exec) directly to execute a command, the
...
[`commands.async`](commands.md#v:async) provides a similar interface to execute asynchronous
...
```
[commands](commands.md).setblock("~", "~1", "~", "minecraft:stone")
```
...
[](#v:exec)exec(command)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L100)
...
```
[commands.exec](commands.md#v:exec)("setblock ~ ~1 ~ minecraft:stone")
```
...
[](#v:execAsync)execAsync(command)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L126)

Asynchronously execute a command.

Unlike [`exec`](commands.md#v:exec), this will immediately return, instead of waiting for the
...
event containing the result of executing this command (what [`exec`](commands.md#v:exec) would
return).
...
```
[commands.execAsync](commands.md#v:execAsync)("setblock ~ ~1 ~ minecraft:stone")
```

### See also

- **[`parallel`](parallel.md)** One may also use the parallel API to run multiple commands at once.

[](#v:list)list(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L139)
...
[](#v:getBlockPosition)getBlockPosition()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L166)
...
- **[`gps.locate`](gps.md#v:locate)** To get the position of a non-command computer.

[](#v:getBlockInfos)getBlockInfos(minX, minY, minZ, maxX, maxY, maxZ [, dimension])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L213)

Get information about a range of blocks.

This returns the same information as [`getBlockInfo`](commands.md#v:getBlockInfo), just for multiple
blocks at once.
...
local x, y, z = [commands.getBlockPosition](commands.md#v:getBlockPosition)()
local min_x, min_y, min_z, max_x, max_y, max_z = x - 1, y - 1, z - 1, x + 1, y + 1, z + 1
local blocks = [commands.getBlockInfos](commands.md#v:getBlockInfos)(min_x, min_y, min_z, max_x, max_y, max_z)
...
[](#v:getBlockInfo)getBlockInfo(x, y, z [, dimension])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/computer/apis/CommandAPI.java#L262)

Get some basic information about a block.

The returned table contains the the same information as listed in [Block details](../reference/block_details.md). If there is a block entity
...
[](#v:native)native[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/command/commands.lua#L35)

The builtin commands API, without any generated command helper functions

This may be useful if a built-in function (such as [`commands.list`](commands.md#v:list)) has been
overwritten by a command.

[](#v:async)async[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/command/commands.lua#L61)

A table containing asynchronous wrappers for all commands.

As with [`commands.execAsync`](commands.md#v:execAsync), this returns the "task id" of the enqueued
command.
...
```
[commands.async](commands.md#v:async).setblock("~", "~1", "~", "minecraft:stone")
```

### See also

- **[`execAsync`](commands.md#v:execAsync)**
