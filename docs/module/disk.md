...
[stopAudio(name)](#v:stopAudio)  Stops the music record in the drive from playing, if it was started with [`disk.playAudio`](disk.md#v:playAudio). 
...
[](#v:isPresent)isPresent(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L32)
...
```
[disk.isPresent](disk.md#v:isPresent)("top")
```

[](#v:getLabel)getLabel(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L49)
...
- **[`disk.setLabel`](disk.md#v:setLabel)**

[](#v:setLabel)setLabel(name, label)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L60)
...
[](#v:hasData)hasData(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L73)
...
- **[`disk.getMountPath`](disk.md#v:getMountPath)**

[](#v:getMountPath)getMountPath(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L87)
...
- **[`disk.hasData`](disk.md#v:hasData)**

[](#v:hasAudio)hasAudio(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L103)

Whether the current disk is a [music disk](https://minecraft.wiki/w/Music_Disc) as opposed to a floppy disk
or other item.

If this returns true, you will can [play](disk.md#v:playAudio) the record.
...
[](#v:getAudioTitle)getAudioTitle(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L117)

Get the title of the audio track from the music record in the drive.

This generally returns the same as [`disk.getLabel`](disk.md#v:getLabel) for records.
...
[](#v:playAudio)playAudio(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L133)
...
track, when it is removed from the drive, when [`disk.stopAudio`](disk.md#v:stopAudio) is called, or
...
```
[disk.playAudio](disk.md#v:playAudio)("bottom")
```

[](#v:stopAudio)stopAudio(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L143)

Stops the music record in the drive from playing, if it was started with
[`disk.playAudio`](disk.md#v:playAudio).

### Parameters

1. name[`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The name o the disk drive.

[](#v:eject)eject(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L159)
...
```
[disk.eject](disk.md#v:eject)("bottom")
```

[](#v:getID)getID(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/disk.lua#L173)

Returns a number which uniquely identifies the disk in the drive.

Note, unlike [`disk.getLabel`](disk.md#v:getLabel), this does not return anything for other media,
