...
[](#v:stdin)stdin[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L243)

A file handle representing the "standard input". Reading from this
file will prompt the user for input.

[](#v:stdout)stdout[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L245)

A file handle representing the "standard output". Writing to this
file will display the written text to the screen.

[](#v:stderr)stderr[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L247)
...
[](#v:close)close([file])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L284)

Closes the provided file handle.

### Parameters

1. file?[`Handle`](io.md#ty:Handle) The file handle to close, defaults to the
current output file.

### See also

- **[`Handle:close`](io.md#ty:Handle:close)**
- **[`io.output`](io.md#v:output)**

### Changes

- **New in version 1.55**

[](#v:flush)flush()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L298)

Flushes the current output file.

### See also

- **[`Handle:flush`](io.md#ty:Handle:flush)**
- **[`io.output`](io.md#v:output)**
...
[](#v:input)input([file])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L308)

Get or set the current input file.

### Parameters

1. file?[`Handle`](io.md#ty:Handle) | [`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The new input file, either as a file path or pre-existing handle.

### Returns

1. [`Handle`](io.md#ty:Handle) The current input file.
...
[](#v:lines)lines([filename, ...])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L349)
...
If no file name is given, the [current input](io.md#v:input) will be used instead.
...
2. ... The argument to pass to [`Handle:read`](io.md#ty:Handle:read) for each line.
...
```
for line in [io.lines](io.md#v:lines)("/rom/help/intro.txt") do
  print(line)
end
```
...
- **[`Handle:lines`](io.md#ty:Handle:lines)**
- **[`io.input`](io.md#v:input)**

### Changes

- **New in version 1.55**

[](#v:open)open(filename [, mode])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L383)
...
1. [`Handle`](io.md#ty:Handle) The opened file.
...
[](#v:output)output([file])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L399)

Get or set the current output file.

### Parameters

1. file?[`Handle`](io.md#ty:Handle) | [`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The new output file, either as a file path or pre-existing handle.

### Returns

1. [`Handle`](io.md#ty:Handle) The current output file.
...
[](#v:read)read(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L420)

Read from the currently opened input file.

This is equivalent to `io.input():read(...)`. See [the documentation](io.md#ty:Handle:read)
...
[](#v:type)type(obj)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L430)
...
[](#v:write)write(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L448)

Write to the currently opened output file.

This is equivalent to `io.output():write(...)`. See [the documentation](io.md#ty:Handle:write)
there for full details.
...
[](#ty:Handle:close)Handle.close()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L42)
...
[](#ty:Handle:flush)Handle.flush()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L61)
...
[](#ty:Handle:lines)Handle.lines(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L96)
...
1. ... The argument to pass to [`Handle:read`](io.md#ty:Handle:read) for each line.
...
```
local file = [io.open](io.md#v:open)("/rom/help/intro.txt")
...
- **[`io.lines`](io.md#v:lines)**

### Changes

- **New in version 1.3**

[](#ty:Handle:read)Handle.read(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L129)
...
[](#ty:Handle:seek)Handle.seek([whence [, offset]])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L189)
...
[](#ty:Handle:setvbuf)Handle.setvbuf(mode [, size])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L211)
...
[](#ty:Handle:write)Handle.write(...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/io.lua#L220)
...
1. [`Handle`](io.md#ty:Handle) The current file, allowing chained calls.
