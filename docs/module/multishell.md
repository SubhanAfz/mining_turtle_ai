...
launched using the `fg` or `bg` programs, or using the [`shell.openTab`](shell.md#v:openTab) and
[`multishell.launch`](multishell.md#v:launch) functions.
...
As with [`shell`](shell.md), [`multishell`](multishell.md) is not a "true" API. Instead, it is a
...
not available to [APIs](os.md#v:loadAPI).
...
[](#v:getFocus)getFocus()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L230)

Get the currently visible process. This will be the one selected on
the tab bar.

Note, this is different to [`getCurrent`](multishell.md#v:getCurrent), which returns the process which is
currently executing.
...
- **[`setFocus`](multishell.md#v:setFocus)**

[](#v:setFocus)setFocus(n)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L240)
...
- **[`getFocus`](multishell.md#v:getFocus)**

[](#v:getTitle)getTitle(n)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L257)

Get the title of the given tab.

This starts as the name of the program, but may be changed using
[`multishell.setTitle`](multishell.md#v:setTitle).
...
[](#v:setTitle)setTitle(n, title)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L273)
...
```
[multishell.setTitle](multishell.md#v:setTitle)([multishell.getCurrent](multishell.md#v:getCurrent)(), "Hello")
```

### See also

- **[`getTitle`](multishell.md#v:getTitle)**

[](#v:getCurrent)getCurrent()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L285)
...
[](#v:launch)launch(tProgramEnv, sProgramPath, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L305)
...
```
local id = [multishell.launch](multishell.md#v:launch)({}, "/rom/programs/fun/hello.lua")
[multishell.setTitle](multishell.md#v:setTitle)(id, "Hello!")
```
...
[](#v:getCount)getCount()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/programs/advanced/multishell.lua#L319)
