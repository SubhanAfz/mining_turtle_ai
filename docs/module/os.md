...
The [`os`](os.md) API allows interacting with the current computer.

[loadAPI(path)](#v:loadAPI)  Loads the given API into the global environment. 

[unloadAPI(name)](#v:unloadAPI)  Unloads an API which was loaded by [`os.loadAPI`](os.md#v:loadAPI). 
...
[sleep(time)](#v:sleep)  Pauses execution for the specified number of seconds, alias of [`_G.sleep`](_G.md#v:sleep). 
...
[cancelTimer(token)](#v:cancelTimer)  Cancels a timer previously started with [`startTimer`](os.md#v:startTimer). 

[setAlarm(time)](#v:setAlarm)  Sets an alarm that will fire at the specified [in-game time](os.md#v:time). 
...
[day([locale])](#v:day)  Returns the day depending on the locale specified. 

[epoch([locale])](#v:epoch)  Returns the number of milliseconds since an epoch depending on the locale. 

[date([format [, time]])](#v:date)  Returns a date string (or table) using a specified format string and optional time to format. 

[](#v:loadAPI)loadAPI(path)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L20)
...
[](#v:unloadAPI)unloadAPI(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L29)

##### 🛈 Deprecated

See [`os.loadAPI`](os.md#v:loadAPI) for why.

Unloads an API which was loaded by [`os.loadAPI`](os.md#v:loadAPI).
...
[](#v:pullEvent)pullEvent([filter])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L67)
...
Unlike [`os.pullEventRaw`](os.md#v:pullEventRaw), it will stop the application upon a "terminate"
...
```
while true do
    local event, button, x, y = [os.pullEvent](os.md#v:pullEvent)("mouse_click")
...
```
while true do
    local eventData = {[os.pullEvent](os.md#v:pullEvent)()}
...
- **[`os.pullEventRaw`](os.md#v:pullEventRaw)** To pull the terminate event.

### Changes

- **Changed in version 1.3:** Added filter argument.

[](#v:pullEventRaw)pullEventRaw([filter])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L90)

Pause execution of the current thread and waits for events, including the
`terminate` event.

This behaves almost the same as [`os.pullEvent`](os.md#v:pullEvent), except it allows you to handle
...
```
while true do
    local event = [os.pullEventRaw](os.md#v:pullEventRaw)()
...
- **[`os.pullEvent`](os.md#v:pullEvent)** To pull events normally.

[](#v:sleep)sleep(time)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L96)

Pauses execution for the specified number of seconds, alias of [`_G.sleep`](_G.md#v:sleep).
...
[](#v:version)version()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L109)
...
```
[os.version](os.md#v:version)()
```

### See also

- **[`_G._HOST`](_G.md#v:_HOST)**

[](#v:run)run(env, path, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/doc/stub/os.lua#L134)
...
provide access to the [`shell`](shell.md) API in the environment. For this behaviour, use
[`shell.run`](shell.md#v:run) instead.
...
```
[os.run](os.md#v:run)({}, "/rom/programs/shell.lua")
```
...
[](#v:queueEvent)queueEvent(name, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L139)
...
- **[`os.pullEvent`](os.md#v:pullEvent)** To pull the event queued

[](#v:startTimer)startTimer(time)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L159)

Starts a timer that will run for the specified number of seconds. Once
the timer fires, a [`timer`](../event/timer.md) event will be added to the queue with the ID
returned from this function as the first parameter.

As with [sleep](os.md#v:sleep), the time will automatically be rounded up to
...
1. `number` The ID of the new timer. This can be used to filter the [`timer`](../event/timer.md)
event, or [cancel the timer](os.md#v:cancelTimer).
...
- **[`cancelTimer`](os.md#v:cancelTimer)** To cancel a timer.

[](#v:cancelTimer)cancelTimer(token)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L172)

Cancels a timer previously started with [`startTimer`](os.md#v:startTimer). This
...
- **[`startTimer`](os.md#v:startTimer)** To start a timer.

### Changes

- **New in version 1.6**

[](#v:setAlarm)setAlarm(time)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L189)

Sets an alarm that will fire at the specified [in-game time](os.md#v:time).
...
`alarm` event, or [cancel the alarm](os.md#v:cancelAlarm).
...
- **[`cancelAlarm`](os.md#v:cancelAlarm)** To cancel an alarm.

### Changes

- **New in version 1.2**

[](#v:cancelAlarm)cancelAlarm(token)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L208)
...
- **[`setAlarm`](os.md#v:setAlarm)** To set an alarm.

### Changes

- **New in version 1.6**

[](#v:shutdown)shutdown()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L218)

Shuts down the computer immediately.

[](#v:reboot)reboot()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L226)

Reboots the computer immediately.

[](#v:getComputerID)getComputerID()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L236)
...
[](#v:computerID)computerID()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L236)
...
[](#v:getComputerLabel)getComputerLabel()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L248)
...
[](#v:computerLabel)computerLabel()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L248)
...
[](#v:setComputerLabel)setComputerLabel([label])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L260)
...
[](#v:clock)clock()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L271)
...
[](#v:time)time([locale])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L305)
...
This function can also be called with a table returned from [`date`](os.md#v:date),
...
- **[`textutils.formatTime`](textutils.md#v:formatTime)** To convert times into a user-readable string.
- **[`date`](os.md#v:date)** To get a date table that can be converted with this function.
...
- **Changed in version 1.83.0:**[`time`](os.md#v:time) now accepts table arguments and converts them to UNIX timestamps.

[](#v:day)day([locale])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L335)
...
1. locale?[`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The locale to get the day for. Defaults to `ingame` if not set.
...
[](#v:epoch)epoch([locale])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L374)
...
1. locale?[`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The locale to get the milliseconds for. Defaults to `ingame` if not set.
...
Get the current time and use [`date`](os.md#v:date) to convert it to a table.

```
-- Dividing by 1000 converts it from milliseconds to seconds.
local time = [os.epoch](os.md#v:epoch)("local") / 1000
local time_table = [os.date](os.md#v:date)("*t", time)
print([textutils.serialize](textutils.md#v:serialize)(time_table))
```
...
[](#v:date)date([format [, time]])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/java/dan200/computercraft/core/apis/OSAPI.java#L426)
...
table can be converted back to a timestamp with [`time`](os.md#v:time).
...
```
[os.date](os.md#v:date)("%A %d %B %Y") -- See the reference above!
```
...
```
[os.date](os.md#v:date)("!*t", 1242534247)
--[=[ {
 -- Date
 year  = 2009,
 month = 5,
