...
be controlled by a computer. For instance, the [`speaker`](../peripheral/speaker.md) peripheral allows a
computer to play music and the [`monitor`](../peripheral/monitor.md) peripheral allows you to display text
in the world.
...
[`peripheral.getNames`](peripheral.md#v:getNames) function.

It's also possible to use peripherals which are further away from your computer
through the use of [Wired Modems](../peripheral/modem.md). Place one modem against your computer
...
[`peripheral.call`](peripheral.md#v:call) function. This takes the name of our peripheral, the name of
...
(for example, the [`peripheral.getMethods`](peripheral.md#v:getMethods) function). Don't worry, they're the
same thing!

Let's say we have a monitor above our computer (and so "top") and want to
[write some text to it](../peripheral/monitor.md#v:write). We'd write the following:

```
[peripheral.call](peripheral.md#v:call)("top", "write", "This is displayed on a monitor!")
```

Once you start calling making a couple of peripheral calls this can get very
repetitive, and so we can [wrap](peripheral.md#v:wrap) a peripheral. This builds a
...
```
local my_monitor = [peripheral.wrap](peripheral.md#v:wrap)("top")
...
Thankfully there's a quick way to do this: [`peripheral.find`](peripheral.md#v:find). This takes a
...
You can get all the types a peripheral has with [`peripheral.getType`](peripheral.md#v:getType), and check
a peripheral is a specific type with [`peripheral.hasType`](peripheral.md#v:hasType).

To return to our original example, let's use [`peripheral.find`](peripheral.md#v:find) to find an
attached speaker:

```
local speaker = [peripheral.find](peripheral.md#v:find)("speaker")
speaker.playNote("harp")
```

### See also

- **[`peripheral`](../event/peripheral.md)** This event is fired whenever a new peripheral is attached.
- **[`peripheral_detach`](../event/peripheral_detach.md)** This event is fired whenever a peripheral is detached.
...
[hasType(peripheral, peripheral_type)](#v:hasType)  Check if a peripheral is of a particular type. 

[getMethods(name)](#v:getMethods)  Get all available methods for the peripheral with the given name. 

[getName(peripheral)](#v:getName)  Get the name of a peripheral wrapped with [`peripheral.wrap`](peripheral.md#v:wrap). 
...
[find(ty [, filter])](#v:find)  Find all peripherals of a specific type, and return the [wrapped](peripheral.md#v:wrap) peripherals. 

[](#v:getNames)getNames()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L110)
...
[](#v:isPresent)isPresent(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L133)
...
```
[peripheral.isPresent](peripheral.md#v:isPresent)("top")
```

- 

```
[peripheral.isPresent](peripheral.md#v:isPresent)("monitor_0")
```

[](#v:getType)getType(peripheral)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L159)
...
```
[peripheral.getType](peripheral.md#v:getType)("top")
```
...
[](#v:hasType)hasType(peripheral, peripheral_type)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L189)
...
2. peripheral_type[`string`](https://www.lua.org/manual/5.1/manual.html#5.4) The type to check.
...
[](#v:getMethods)getMethods(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L217)
...
[](#v:getName)getName(peripheral)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L236)

Get the name of a peripheral wrapped with [`peripheral.wrap`](peripheral.md#v:wrap).
...
[](#v:call)call(name, method, ...)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L255)
...
```
[peripheral.call](peripheral.md#v:call)("top", "open", 1)
```

[](#v:wrap)wrap(name)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L281)

Get a table containing all functions available on a peripheral. These can
then be called instead of using [`peripheral.call`](peripheral.md#v:call) every time.
...
```
local modem = [peripheral.wrap](peripheral.md#v:wrap)("top")
modem.open(1)
```

[](#v:find)find(ty [, filter])[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/core/src/main/resources/data/computercraft/lua/rom/apis/peripheral.lua#L332)

Find all peripherals of a specific type, and return the
[wrapped](peripheral.md#v:wrap) peripherals.
...
```
local monitors = { [peripheral.find](peripheral.md#v:find)("monitor") }
...
```
local modems = { [peripheral.find](peripheral.md#v:find)("modem", function(name, modem)
...
This abuses the `filter` argument to call [`rednet.open`](rednet.md#v:open) on every modem.
