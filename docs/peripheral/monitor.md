...
Monitors act as [terminal redirects](../module/term.md#ty:Redirect) and so expose the same methods, as well as several additional
ones, which are documented below.

If the monitor is resized (by adding new blocks to the monitor, or by calling [`setTextScale`](monitor.md#v:setTextScale)), then a
[`monitor_resize`](../event/monitor_resize.md) event will be queued.

Like computers, monitors come in both normal (no colour) and advanced (colour) varieties. Advanced monitors be right
clicked, which will trigger a [`monitor_touch`](../event/monitor_touch.md) event.
...
![Monitor](https://tweaked.cc/images/items/computercraft/monitor_normal.png)
...
![Advanced Monitor](https://tweaked.cc/images/items/computercraft/monitor_advanced.png)4
...
```
local monitor = [peripheral.find](../module/peripheral.md#v:find)("monitor")
...
- **[`monitor_resize`](../event/monitor_resize.md)** Queued when a monitor is resized.
- **[`monitor_touch`](../event/monitor_touch.md)** Queued when an advanced monitor is clicked.
...
[setCursorBlink(blink)](#v:setCursorBlink)  Sets whether the cursor should be visible (and blinking) at the current [cursor position](monitor.md#v:getCursorPos). 

[getSize()](#v:getSize)  Get the size of the terminal. 

[clear()](#v:clear)  Clears the terminal, filling it with the [current background colour](monitor.md#v:getBackgroundColour). 

[clearLine()](#v:clearLine)  Clears the line the cursor is currently on, filling it with the [current background colour](monitor.md#v:getBackgroundColour). 
...
[](#v:setTextScale)setTextScale(scale)[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/peripheral/monitor/MonitorPeripheral.java#L66)
...
- **[`getTextScale`](monitor.md#v:getTextScale)**

[](#v:getTextScale)getTextScale()[Source](https://github.com/cc-tweaked/CC-Tweaked/blob/db32ddfec5e8c2bdefb3232b471328a3e92cc43f/projects/common/src/main/java/dan200/computercraft/shared/peripheral/monitor/MonitorPeripheral.java#L80)
...
Set the position of the cursor. [terminal writes](monitor.md#v:write) will begin from this position.
...
Sets whether the cursor should be visible (and blinking) at the current [cursor position](monitor.md#v:getCursorPos).
...
Clears the terminal, filling it with the [current background colour](monitor.md#v:getBackgroundColour).
...
colour](monitor.md#v:getBackgroundColour).
...
- **[`colors`](../module/colors.md)** For a list of colour constants, returned by this function.
...
- **[`colors`](../module/colors.md)** For a list of colour constants.
...
Return the current background colour. This is used when [writing text](monitor.md#v:write) and [clearing](monitor.md#v:clear)
the terminal.
...
Set the current background colour. This is used when [writing text](monitor.md#v:write) and [clearing](monitor.md#v:clear) the
terminal.
...
As with [`write`](monitor.md#v:write), the text will be written at the current cursor location, with the cursor
...
```
[term.blit](../module/term.md#v:blit)("Hello, world!","01234456789ab","0000000000000")
```

### See also

- **[`colors`](../module/colors.md)** For a list of colour constants, and their hexadecimal values.
...
can make [`colors.red`](../module/colors.md#v:red)*more red* by setting its palette to #FF0000. This does now allow you to draw more
...
Change the [red colour](../module/colors.md#v:red) from the default #CC4C4C to #FF0000.

```
[term.setPaletteColour](../module/term.md#v:setPaletteColour)([colors.red](../module/colors.md#v:red), 0xFF0000)
[term.setTextColour](../module/term.md#v:setTextColour)([colors.red](../module/colors.md#v:red))
print("Hello, world!")
```
...
```
[term.setPaletteColour](../module/term.md#v:setPaletteColour)([colors.red](../module/colors.md#v:red), 1, 0, 0)
[term.setTextColour](../module/term.md#v:setTextColour)([colors.red](../module/colors.md#v:red))
print("Hello, world!")
```
...
- **[`colors.unpackRGB`](../module/colors.md#v:unpackRGB)** To convert from the 24-bit format to three separate channels.
- **[`colors.packRGB`](../module/colors.md#v:packRGB)** To convert from three separate channels to the 24-bit format.
