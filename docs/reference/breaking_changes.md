...
## [](#cct-1.109)CC: Tweaked 1.109.0 to 1.109.3
...
## [](#mc-1.13)Minecraft 1.13

- 

The "key code" for [`key`](../event/key.md) and [`key_up`](../event/key_up.md) events has changed, due to Minecraft updating to LWJGL 3. Make sure you're
using the constants provided by the [`keys`](../module/keys.md) API, rather than hard-coding numerical values.
...
result [`turtle.inspect`](../module/turtle.md#v:inspect) no longer provides block metadata, and [`turtle.getItemDetail`](../module/turtle.md#v:getItemDetail) no longer provides damage.
...
## [](#cc-1.88)CC: Tweaked 1.88.0

- Unlabelled computers and turtles now keep their ID when broken, meaning that unlabelled computers/items do not stack.

## [](#cc-1.80)ComputerCraft 1.80pr1

- 

Programs run via [`shell.run`](../module/shell.md#v:run) are now started in their own isolated environment. This means globals set by programs
